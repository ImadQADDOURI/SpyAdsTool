          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="max-w-2xl text-lg text-gray-600 dark:text-gray-300">
                Calculate and optimize your cost per action, track campaign ROI,
                and maximize advertising profitability with our advanced CPA
                tools.
              </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h2 className="mb-2 text-xl font-semibold text-gray-800 dark:text-gray-200">
                CPA Marketing Performance Analysis
              </h2>
              <p className="text-gray-600 dark:text-gray-400">
                This comprehensive calculator helps e-commerce professionals
                evaluate their marketing performance by calculating essential
                metrics related to costs, conversions, and profitability in CPA
