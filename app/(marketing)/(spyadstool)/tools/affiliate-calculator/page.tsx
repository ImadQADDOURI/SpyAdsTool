          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="max-w-2xl text-lg text-gray-600 dark:text-gray-300">
                Calculate affiliate campaign ROI, commission costs, and profit
                margins. Make data-driven decisions to optimize your affiliate
                partnerships and maximize returns.
              </p>
