...
export const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  const xOffset = isFront ? "0%" : position === "middle" ? "35%" : "70%";
  const scale = isFront ? 1.0 : position === "middle" ? 0.9 : 0.8;
  ...
  return (
    <motion.div
      className={cn(
        ...
        "h-[260px] w-[220px] sm:h-[280px] sm:w-[240px]",
    ...
    >
      ...
      <img
        ...
        className="h-14 w-14 rounded-full border-2 border-gray-600 bg-gray-600 object-cover sm:h-16 sm:w-16"
      />
