          ...
          <Card className="overflow-hidden border-pink-200 bg-white shadow-xl ring-1 ring-pink-100 transition-all duration-300 hover:border-pink-300 hover:shadow-2xl dark:border-pink-700 dark:bg-gray-950 dark:ring-pink-800 dark:hover:border-pink-600">
            <CardContent className="p-0">
              <div className="flex flex-col lg:flex-row">
                <div className="relative flex flex-col justify-center overflow-hidden bg-gradient-to-br from-pink-500 to-rose-600 p-3 dark:from-pink-600 dark:to-rose-700 sm:p-5 lg:w-1/3">
        ...
        <div className="mt-4 space-y-3 sm:mt-6 sm:space-y-4">
          <div className="mx-auto max-w-4xl">
            <div className="grid gap-2 sm:gap-3 md:grid-cols-3">
              <div className="flex items-center gap-2 rounded-xl bg-gradient-to-br from-green-50 to-green-100/50 p-2.5 shadow-sm transition-all duration-200 hover:shadow-md dark:from-green-900/20 dark:to-green-800/10 sm:gap-3 sm:p-3">
              ...
              <div className="flex items-center gap-2 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/50 p-2.5 shadow-sm transition-all duration-200 hover:shadow-md dark:from-blue-900/20 dark:to-blue-800/10 sm:gap-3 sm:p-3">
              ...
              <div className="flex items-center gap-2 rounded-xl bg-gradient-to-br from-red-50 to-red-100/50 p-2.5 shadow-sm transition-all duration-200 hover:shadow-md dark:from-red-900/20 dark:to-red-800/10 sm:gap-3 sm:p-3">
