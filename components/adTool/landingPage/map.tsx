                    ...
                    >
                      ...
                      >
                        <div className="flex h-full items-center justify-center">
                          <span className="rounded-md border border-gray-200 bg-white/95 px-2 py-0.5 text-sm font-medium text-black shadow-sm dark:border-gray-700 dark:bg-black/95 dark:text-white">
                            {dot.start.label}
                          </span>
                        </div>
                      </foreignObject>
