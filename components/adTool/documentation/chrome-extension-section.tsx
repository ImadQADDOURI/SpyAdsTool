import { AlertCircle, CheckCircle, Info, Puzzle } from "lucide-react";
      ...
      <CardContent className="space-y-6">
        <div className="prose prose-slate max-w-none dark:prose-invert">
          <p className="mb-6 text-slate-700 dark:text-slate-300">
            This platform includes Chrome Extension integration capabilities for
            enhanced ad search functionality. The extension can communicate with
            your web application through secure API endpoints.
          </p>
          ...
          <Alert className="mb-6">
            ...
            <AlertDescription>
              ...
              file to handle CORS properly for both development and production
              environments.
            </AlertDescription>
          </Alert>
          ...
          <Tabs defaultValue="configuration" className="w-full">
            ...
            <TabsContent value="configuration" className="space-y-6">
              ...
              <p className="text-slate-700 dark:text-slate-300">
                The platform includes specific CORS configuration for Chrome
        ...
        headers: [
          ...
          },
          {
            ...
            <TabsContent value="development" className="space-y-6">
              ...
              <p className="text-slate-700 dark:text-slate-300">
                During development, the CORS policy is set to allow all origins
                (*) for easier testing.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg bg-slate-50 p-4 dark:bg-slate-800">
                  ...
                  <div className="rounded bg-slate-900 p-3 text-sm dark:bg-slate-700">
                    <code className="text-green-400">
                      ...
                      <br /># Chrome extension origin not required in
                      development
                      <br />#
                      CHROME_EXTENSION_ORIGIN=chrome-extension://your_dev_extension_id
                    </code>
                  </div>
                </div>
                ...
                <Alert>
                  <Info className="h-4 w-4" />
                  <AlertDescription>
                    <strong>Development Tip:</strong> You can test your Chrome
                    extension with the development server without setting the
                    CHROME_EXTENSION_ORIGIN variable, as development mode allows
                    all origins.
                  </AlertDescription>
                </Alert>
              </div>
            ...
            <TabsContent value="production" className="space-y-6">
              ...
              <p className="text-slate-700 dark:text-slate-300">
                In production, you must specify the exact Chrome extension
                origin for security.
              </p>
              ...
              <Alert className="mb-6">
                ...
                <AlertDescription>
                  <strong>Security Critical:</strong> In production, CORS is
                  restricted to your specific Chrome extension ID only. This
                  prevents unauthorized access to your API endpoints.
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-4">
                ...
                <ol className="space-y-2 text-slate-700 dark:text-slate-300">
                  <li>
                    1. Publish your Chrome extension to the Chrome Web Store
                  </li>
                  <li>
                    2. Copy the extension ID from the store URL or extension
                    management page
                  </li>
                  <li>
                ...
                <div className="grid gap-4">
                  <div className="rounded-lg border border-slate-200 p-4 dark:border-slate-700">
                    ...
                    <div className="rounded bg-slate-900 p-2 text-xs dark:bg-slate-800">
                      <code className="text-green-400">
                  ...
                  <div className="rounded-lg border border-slate-200 p-4 dark:border-slate-700">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">
                      Set the environment variable through your platform&apos;s
                      dashboard or deployment configuration.
                    </p>
                  </div>
                </div>
                ...
                <Alert className="mt-4">
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    <strong>Important:</strong> If the CHROME_EXTENSION_ORIGIN
                    environment variable is not set in production, you&apos;ll
                    see a warning in your application logs, and the extension
