...
export function TechStackSection() {
  const techStack = [
    { name: "Next.js 14", description: "React framework with App Router", category: "Frontend" },
    ...
    { name: "Cloudflare R2", description: "Media storage", category: "Storage" },
    { name: "Resend", description: "Email service", category: "Email" },
    { name: "Tailwind CSS", description: "Styling framework", category: "Styling" },
    ...
    <Card id="overview">
      ...
      <CardContent className="space-y-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {techStack.map((tech) => (
            <div key={tech.name} className="p-4 border rounded-lg bg-slate-50 dark:bg-slate-800/50">
