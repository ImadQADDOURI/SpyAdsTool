...
const STORAGE_KEY = "affiliate-calculator-data";

const AffiliateMarketingCalculator: React.FC = () => {
  ...
  }, [clicks, conversionRate, orderValue, commissionRate, extraCharges]);

  const conversions = clicks * (conversionRate[0] / 100);

  const totalSales = orderValue * conversions;

  const totalCommission = totalSales * (commissionRate[0] / 100);
  ...
  const totalExtraCharges = extraCharges.reduce((total, charge) => {
    ...
    const base = charge.application === "perOrder" ? totalSales : totalSales;
    return total + (charge.amount / 100) * base;
  }, 0);

  const netEarnings = totalCommission - totalExtraCharges;

  const roi =
    totalExtraCharges > 0 ? (netEarnings / totalExtraCharges) * 100 : 0;
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="shadow-sm">
          ...
          <CardContent className="space-y-5">
            ...
            <div className="space-y-2">
              <Label className="text-sm font-medium">
                Commission Rate: {commissionRate[0].toFixed(1)}%
              </Label>
              <div className="flex items-center gap-3">
                <Slider
                ...
                {extraCharges.map((charge) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="perOrder">Per Sale</SelectItem>
            ...
            <div className="rounded-lg bg-blue-50 p-3 dark:bg-blue-900/20">
              <div className="flex items-start gap-2 text-xs text-blue-700 dark:text-blue-300">
                ...
                <p>
                  Track affiliate earnings minus your expenses. Your data is
                  automatically saved.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <Card className="border-[#6566F1]/20 bg-gradient-to-br from-[#6566F1] to-[#8B7DF8] text-white shadow-md">
              ...
              <CardContent>
                <p className="text-3xl font-bold">${netEarnings.toFixed(2)}</p>
            ...
            <Card className="shadow-sm">
              <CardHeader className="pb-2">
                <CardTitle className="flex items-center gap-2 text-base font-semibold">
                  <Users size={18} className="text-[#6566F1]" />
                  Commission
                </CardTitle>
              </CardHeader>
              <CardContent>
...
export default AffiliateMarketingCalculator;
