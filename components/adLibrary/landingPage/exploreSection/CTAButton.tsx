    ...
    (
      ...
      const variantStyles = {
        default: isForcedDark
          ...
          : isForcedLight
            ? "border border-black/10 bg-gradient-to-tr from-blue-300/20 via-purple-400/30 to-pink-300/20 text-gray-900 hover:from-blue-300/30 hover:via-purple-400/40 hover:to-pink-300/30"
        ...
        outline: isForcedDark
          ? "border-2 border-purple-400/50 bg-transparent text-white hover:border-purple-300 hover:bg-purple-500/10"
          : isForcedLight
            ? "border-2 border-purple-400/50 bg-transparent text-gray-900 hover:border-purple-500 hover:bg-purple-50"
        ...
        ghost: isForcedDark
          ...
          : isForcedLight
            ? "border border-transparent bg-transparent text-gray-900 hover:bg-purple-50"
